...
class successAdded extends StatefulWidget {
  const successAdded({Key? key}) : super(key: key);

  @override
  _successAddedState createState() => _successAddedState();
}

class _successAddedState extends State<successAdded> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          dense:true,
                          leading:Icon(Icons.lock,size:height*0.05,),
                        ...
                        ListTile(
                          ...
                          horizontalTitleGap:10,
                          dense:true,
                          leading:Icon(Icons.perm_identity_rounded,size:height*0.05,),
